    ...
    <div class="AUInfo-main">
        <ul>
            <li>
                ...
                <input value="${ss.shr}" type="text" id="shr" placeholder="请输入真实姓名"   style="height: 45px;color: #ada2a2;border-bottom: 0px;text-align: left;padding: 0;margin: 0;background-color: transparent;">

            </li>
            <li>
                <p style="font-size: 0.9em;">手机号码</p>
                <input value="${ss.tel}" type="text" id="sjhm" placeholder="请填写手机号码" style="height: 45px;color: #ada2a2;border-bottom: 0px;text-align: left;padding: 0;margin: 0;background-color: transparent;">
            </li>
            <li>
                <p style="font-size: 0.9em;">确认手机号码</p>
                <input value="${ss.tel}" type="text" id="qrsjhm"  placeholder="请再次输入手机号码" style="height: 45px;color: #ada2a2;border-bottom: 0px;text-align: left;padding: 0;margin: 0;background-color: transparent;">
            </li>
            <li>
                <p style="font-size: 0.9em;">省市区</p>
                <input value="${ss.area}" type="text" id="ssq" placeholder="请选择城市地址" style="height: 45px;color: #ada2a2;border-bottom: 0px;text-align: left;padding: 0;margin: 0;background-color: transparent;">
            </li>
            <li>
                <p style="width: 100%;font-size: 0.9em;"><input value="${ss.address}" type="text" id="xqdz" placeholder="请输入收货人的详情地址" style="height: 45px;color: #ada2a2;border: 0px;text-align: left;padding: 0;margin: 0;background-color: transparent;font-size: 0.9em;"></p>
            </li>
