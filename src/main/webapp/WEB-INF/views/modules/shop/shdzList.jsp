...
<div style="width: 100%;">
    ...
    <a href="${shop}/xgshList?data=${sAddress.id}"><p style="float: right;font-size: 2em;margin-right: 2rem;margin-top: .2rem;"><input type="button" value="修改" style="font-size:0.8em;margin: 0;background-color: transparent;color: #999;"></p></a>
