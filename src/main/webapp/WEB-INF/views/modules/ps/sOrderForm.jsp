...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ps/sOrder/">订单列表</a></li>
		<li class="active"><a href="${ctx}/ps/sOrder/form?id=${sOrder.id}">订单<shiro:hasPermission name="ps:sOrder:edit">${not empty sOrder.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ps:sOrder:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sOrder" action="${ctx}/ps/sOrder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
